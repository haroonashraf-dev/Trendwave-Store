    ...
    <header
      className={cn(
        ...
        isScrolled || isMobileMenuOpen
          ? 'bg-white/95 backdrop-blur-xl border-gray-200 shadow-sm py-3'
          : 'bg-white/60 backdrop-blur-lg border-gray-200/30 py-5'
      )}
    >
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            >
              ...
              {itemCount > 0 && (
                <span className="absolute top-1.5 right-1.5 bg-black text-white text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center ring-2 ring-white">
                  {itemCount}
                </span>
              )}
            </button>
