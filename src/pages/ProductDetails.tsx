        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="flex lg:flex-col gap-4 overflow-x-auto lg:overflow-y-auto lg:w-24 hide-scrollbar">
              {product.images.map((img, idx) => (
                <button
                  ...
                  className={`flex-shrink-0 w-20 lg:w-full aspect-[3/4] rounded-lg overflow-hidden border-2 transition-colors ${
          ...
          <div className="flex flex-col pt-4 lg:pt-8">
            ...
            {product.stock < 10 && product.stock > 0 && (
              <div className="flex items-center gap-2 text-red-600 text-sm font-medium mb-6 bg-red-50 p-3 rounded-md">
